...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named PostBridgeMobile
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to PostBridgeMobile.
...
- __Website__ refers to PostBridgeMobile, accessible from [PostBridgeMobile.ru](PostBridgeMobile.ru)
